...
export default function DevicesContextProvider({ children }) {
  ...
  function findDevices() {
    ...
    axios
      .get("https://energywiseback.azurewebsites.net/device/findDev", {
        headers: {
  ...
  function fetchDevicesData(tipo) {
    return axios
      .post(
        "https://energywiseback.azurewebsites.net/device/model",
        { variable: tipo },
        {
          headers: {
  ...
  function addDevice(dataToSend) {
    ...
    return axios
      .post("https://energywiseback.azurewebsites.net/device/dev", dataToSend, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  function deleteDevice(id) {
    ...
    return axios
      .delete("https://energywiseback.azurewebsites.net/device/delete", {
        headers: {
          Authorization: `Bearer ${token}`,
        },
        data: { id },
  ...
  function switchDevice(idDevModel, idDevice) {
    ...
    return axios
      .post("https://energywiseback.azurewebsites.net/device/", payload, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      })
  ...
  const getDeviceConfiguration = async (device) => {
    ...
    try {
      ...
      const response = await axios.get(
        `https://energywiseback.azurewebsites.net/devControl/deviceConfiguration?deviceId=${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  function saveDeviceConfiguration(device, config) {
    ...
    return axios
      .post(
        "https://energywiseback.azurewebsites.net/devControl/programDev",
        payload,
        {
          headers: {
            Authorization: `Bearer ${token}`,
